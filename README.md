...
- `main.js`: scroll reveal effects, year, and dynamic photo/certificate/content cards
...
- `Content Manager Portfolio/`: content manager project assets, campaign videos, posters, guides, and work samples
- `Operations Application Logo/`: logos for operations, content, communication, scheduling, and workflow applications
...
- Edit content manager cards in `main.js` under `contentManagerEvidenceItems`, `contentManagerVideoItems`, `contentManagerPosterItems`, and `contentManagerWorkSampleItems`.
- Edit operations application logos in `main.js` under `operationsApplicationLogoItems`.
